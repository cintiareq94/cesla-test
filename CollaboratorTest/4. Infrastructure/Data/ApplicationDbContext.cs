    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Collaborator>().HasData(
                new Collaborator { Id = 1, Name = "John Doe", Document = "1234567890", Phone = "555-1234", Email = "john.doe@example.com", Address = "123 Main St", IsEnabled = true },
                new Collaborator { Id = 2, Name = "Jane Smith", Document = "9876543210", Phone = "555-5678", Email = "jane.smith@example.com", Address = "456 Elm St", IsEnabled = true },
                new Collaborator { Id = 3, Name = "Alice Johnson", Document = "4561237890", Phone = "555-8765", Email = "alice.johnson@example.com", Address = "789 Oak St", IsEnabled = true },
                new Collaborator { Id = 4, Name = "Bob Brown", Document = "7893216540", Phone = "555-4321", Email = "bob.brown@example.com", Address = "321 Pine St", IsEnabled = true },
                new Collaborator { Id = 5, Name = "Eve Adams", Document = "6549871230", Phone = "555-9876", Email = "eve.adams@example.com", Address = "654 Maple St", IsEnabled = true }
            );
            ...
            modelBuilder.Entity<CollaboratorCompanyLink>().HasData(
                ...
                new CollaboratorCompanyLink { Id = 5, CollaboratorId = 5, CompanyId = 5, Role = "Engineer", Department = "R&D", IsEnabled = true },
                ...
                new CollaboratorCompanyLink { Id = 9, CollaboratorId = 4, CompanyId = 5, Role = "Analyst", Department = "Finance", IsEnabled = true },
